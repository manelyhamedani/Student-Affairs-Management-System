...
int get_send_charge_input(send_charge_parameter *input) {
    ...
    printf("Are you sure to send charge to this student?(y or n) ");
    char choice;
    scanf("%c", &choice);
...
int get_charge_account_input(charge_account_parameter *input) {
    ...
    printf("Card-number: ");
    scanf("%s", input->card_number);
    printf("Pass-code: ");
    scanf("%s", input->pass_code);
    return success;
}
...
int get_system_report_input(system_report_parameter *input) {
    ...
    scanf("%s", input->start_date);
    printf("End_date(YYYY-MM-DD): ");
    scanf("%s", input->end_date);
    return success;
}
...
void get_statistics_input(statistics_parameter *input) {
    system("clear");
    printf("Date: ");
    scanf("%s", input->date);
    printf("Meal: ");
...
void get_datetime_input(datetime_parameter *input) {
    system("clear");
    printf("Date(YYYY-MM-DD): ");
    scanf("%s", input->date);
    printf("Time(HHMM): ");
...
void get_change_pass_input(change_pass_parameter *input) {
    system("clear");
    printf("User_id: ");
    scanf("%s", input->user_id);
    char *temp_pass;
...
int get_remove_input(remove_student_parameter *input) {
    ...
    printf("Student_id: ");
    scanf("%s", input->user_id);
    printf("Are you sure to remove this student?(y or n) ");
    char choice;
    scanf("%c", &choice);
    if (choice == 'n' || choice == 'N') {
        system("clear");
...
void get_poll_input(poll_parameter *input) {
    system("clear");
    printf("Question: ");
    scanf("%[^'\n']", input->question);
    printf("Option 1: ");
...
void get_news_input(news_parameter *input) {
    system("clear");
    printf("Title: ");
    scanf("%[^'\n']", input->title);
    printf("Content: ");
...
void get_food_input(food_parameter *input) {
    system("clear");
    printf("Food_id: ");
    scanf("%s", input->food_id);
    printf("Food_name: ");
...
void student_menu(void) {
    ...
    switch (choice) {
        case 1:
            if (get_reserve_input(&reserve_input) == not_found) {
                student_menu();
                break;
            }
            ...
            break;
        case 2:
            if (get_take_food_input(&take_food_input) == not_found) {
                student_menu();
                break;
            }
        ...
        case 4:
            ...
            break;
        case 5:
            if (get_cancel_reserve_input(&cancel_reserve_input) == not_found) {
                student_menu();
                break;
            }
            ...
            break;
        case 6:
            if (get_daily_reserve_input(&daily_reserve_input) == not_found) {
                student_menu();
                break;
            }
            ...
            break;
        case 7:
            if (get_agent_input(&agent_input) == not_found) {
                student_menu();
                break;
            }
            ...
            break;
        case 8:
            if (get_change_self_input(&change_self_input) == not_found) {
                student_menu();
                break;
            }
        ...
        case 9:
            ...
            break;
        case 10:
            if (get_vote_input(&vote_input) == not_found) {
                student_menu();
                break;
            }
        ...
        case 11:
            ...
            break;
        case 12:
            get_change_pass_input(&change_pass_input);
            ...
            break;
        case 13:
            get_datetime_input(&datetime_input);
...
void admin_menu(void) {
    ...
    switch (choice) {
        ...
        case 3:
            ...
            break;
        case 4:
            if (get_meal_plan_input(&meal_plan_input) == not_found) {
                admin_menu();
                break;
            }
        ...
        case 7:
            ...
            break;
        case 8:
            if (get_deactivate_input(&deactivate_input) == not_found) {
                admin_menu();
                break;
            }
            ...
            break;
        case 9:
            result = get_remove_input(&remove_input);
            if (result == not_found || result == cancel) {
                admin_menu();
                break;
            }
            ...
            break;
        case 10:
            if (get_change_student_pass_input(&change_student_pass_input) == not_found) {
                admin_menu();
                break;
            }
            ...
            break;
        case 11:
            if (get_charge_student_account_input(&charge_student_account_input) == not_found) {
                admin_menu();
                break;
            }
        ...
        case 14:
            ...
            break;
        case 15:
            get_statistics_input(&statistics_input);
            ...
            break;
        case 16:
            if (get_student_report_input(&student_report_input) == not_found) {
                admin_menu();
                break;
            }
            ...
            break;
        case 17:
            if (get_system_report_input(&system_report_input) == cancel) {
                admin_menu();
                break;
            }
